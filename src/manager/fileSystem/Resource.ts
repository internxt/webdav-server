...
export class Resource {
  ...
  openWriteStreamAsync(
    ...
    return this.fs.openWriteStreamAsync(
      this.context,
      this.path,
      _mode,
      _targetSource,
  ...
  openReadStreamAsync(
    ...
    return this.fs.openReadStreamAsync(
      this.context,
      this.path,
      _targetSource,
      _estimatedSize
  ...
  readDirAsync(_retrieveExternalFiles?: any): Promise<string[]> {
    return this.fs.readDirAsync(
      this.context,
      this.path,
      _retrieveExternalFiles
    );
  }
